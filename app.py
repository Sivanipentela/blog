...
mydb=mysql.connector.connect(host='localhost',user='root',password='system',database='Tarak')
with mysql.connector.connect(host='localhost',user='root',password='system',database='Tarak'):
    cursor=mydb.cursor(buffered=True)
    cursor.execute("create table if not exists registration(username varchar(15) primary key,mobile varchar(10) unique,address varchar(20),email varchar(30) unique,password varchar(15))")
app=Flask(__name__)
